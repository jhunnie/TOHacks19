...
class Firestore {
    ...
    constructor(settings) {
        ...
        if (process.env.FIRESTORE_EMULATOR_HOST) {
            ...
            this.validateAndApplySettings(Object.assign({ host: process.env.FIRESTORE_EMULATOR_HOST, ssl: false, customHeaders: {
                    Authorization: 'Bearer owner',
                } }, settings, libraryHeader));
        }
        else {
    ...
    runTransaction(updateFunction, transactionOptions) {
        ...
        return this.initializeIfNeeded().then(() => this._runTransaction(updateFunction, transactionOptions));
    }
    ...
    getAll(...documentRefsOrReadOptions) {
        ...
        return this.initializeIfNeeded().then(() => this.getAll_(documents, fieldMask, util_1.requestTag()));
    }
    /**
