...
const map = function (obj, fn, context) {
    var res = {};
    for (var key in obj) {
...
const findKey = function (obj, fn, context) {
    for (var key in obj) {
...
const findValue = function (obj, fn, context) {
    var key = findKey(obj, fn, context);
    return key && obj[key];
};
const getAnyKey = function (obj) {
    for (var key in obj) {
        return key;
    }
};
 ...
 */
const querystring = function (querystringParams) {
    const params = [];
 ...
 * @return {!Object}
 */
const querystringDecode = function (querystring) {
    const obj = {};
